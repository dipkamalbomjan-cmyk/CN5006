...
// Database connection
const MONGO_URI = 'mongodb+srv://admin:admin@cluster0.stek0di.mongodb.net/week8';
...
db.once('connected', async function() {
    ...
    try {
        ...
        console.log("\n=== TASK 2: Adding Multiple Documents ===");
        const manypersons = [
            { name: 'Andrew', age: 42, Gender: "Male", Salary: 3456 },
            { name: 'Neesha', age: 23, Gender: "Female", Salary: 1000 },
            { name: 'john', age: 27, Gender: "Female", Salary: 5402 },
